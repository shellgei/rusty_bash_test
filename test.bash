...
./test_fixed_v1.2.9.bash nobuild "$repo_dir" &
./test_fixed_v1.3.0.bash nobuild "$repo_dir" &
./test_fixed_v1.3.1.bash nobuild "$repo_dir" &
./test_fixed_v1.3.2.bash nobuild "$repo_dir" &
